...
function App() { 
  ...
  return (
    < >
       ...
       <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-slate-700 min-h-[80vh] md:w-[35%]">
        <div className='bg-slate-700 p-2 rounded-xl' >
        <h1 className='font-bold text-center text-3xl text-yellow-400  '>TO DO LIST</h1>
        </div>
         ...
         <label className='mx-2 text-blue-400 text-xl font-semibold ' htmlFor="show">Show Finished</label> 
         <div className='h-[1px] bg-black opacity-15 w-[90%] mx-auto my-2'></div>
         <h2 className='text-2xl font-bold text-lime-200 '>Your Todos</h2>
         <div className="todos">
          ...
          return (showFinished || !item.isCompleted) && <div key={item.id} className={`todo flex my-3 justify-between text-white`}>
            ...
            <div className="buttons flex h-full">
              ...
              <button onClick={(e)=>{handleDelete(e, item.id)}} className='bg-red-600 hover:bg-red-400 p-2 py-1 text-sm font-bold text-white rounded-md mx-1'>Delete</button>
            </div> 
          </div>
          })}
         </div>
